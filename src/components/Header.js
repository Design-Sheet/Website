...
<Navbar  className="pt-0 pb-0  nav_color" collapseOnSelect expand="md"   variant="light">
  ...
  <img className="img1" src="./images/logoblue@1X.png" alt=""></img>
    <img className="img2" src="./images/DesignSheets@1X.png" alt=""></img>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav>
      ...
      <Nav.Link href="/career1" className='text-color'><div className="hover">Careers</div></Nav.Link>
      <Nav.Link href="https://n6lcpj2e6wu.typeform.com/to/zEFYIK2K" className='text-color '><div className='hover'>Register</div></Nav.Link>
    </Nav>
  </Navbar.Collapse>
</Navbar>
        </div>
