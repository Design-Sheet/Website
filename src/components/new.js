        ...
        <Col lg={4} sm={9} xs={9} className='mx-auto my-auto mt-5 pt-5'>
          <ListGroup>
            ...
            <div className='width2' style={{ textAlign: 'center' }}>
              {' '}
              All design fields namely:Architecture,
              <br />
               Planning, Interior Design, Landscape,
              <br /> Graphic Design,and Product Design.
            </div>
          </ListGroup>
        </Col>
      ...
      <Row>
        <Col lg={4} sm={9} xs={9} className='mx-auto my-auto mt-5 pt-5'>
          <ListGroup>
            ...
            <div className='width2' style={{ textAlign: 'center' }}>
              Discover 1000+ templates specific to each design field, designed
              by the the best and guided by the experts. No need to search for
              that one marble among thousands others, with customized search
              results to find the you the right fit.
            </div>
          </ListGroup>
        </Col>
        <Col lg={5} sm={9} xs={9} className=' mt-5 mx-auto my-auto pt-5 pb-5'>
      ...
      <Row>
        ...
        <Col lg={4} sm={9} xs={9} className='mx-auto my-auto mt-5 pt-5'>
          <ListGroup>
            ...
            <div className='width2' style={{ textAlign: 'center' }}>
              {' '}
              User friendly, simple and intuitive workspace, with no prior
              knowledge needed to design. Either choose from the 1000+templates
