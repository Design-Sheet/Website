        ...
        <div className="">
            ...
            <div className="important_background">
             ...
             <Row className='section3 background_color px-auto imortant_background' style={{textAlign:'center'}}>
                ...
                <Col >
                     <Image src="./images/clock.png" className="background_image"></Image>
                     <p>TIME SAVER</p>
                </Col> 
                <Col >
                     <Image src="./images/rocket.png" className="background_image"></Image>
                     <p>INNOVATIVE</p>
                </Col>
                <Col >
                     <Image src="./images/high-five.png" className="background_image"></Image>
                     <p>USER FRIENDLY</p>
                </Col>
                <Col>
